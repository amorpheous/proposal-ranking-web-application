...
public class routes {
  ...
  public static final controllers.ReverseProposalController ProposalController = new controllers.ReverseProposalController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseProposalController ProposalController = new controllers.javascript.ReverseProposalController(RoutesPrefix.byNamePrefix());
